...
class TaskSetGenerator():
    ...
    def generate_with_task_limit(self, num_tasks, max_init_offset, max_wcet, max_duration):
        tasks = []
    ...
    def generate_task(self, index, max_init_offset, max_wcet, max_duration):
        periods = [1000000, 2000000, 5000000, 10000000, 20000000, 50000000, 100000000, 200000000, 500000000, 1000000000]
